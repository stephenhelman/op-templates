...
import { authorityDefaults, fontPairings } from "@/lib/templateDefaults";
...
export default function AuthorityTemplatePage() {
  const [config, setConfig] = useState<TemplateConfig>(authorityDefaults);
